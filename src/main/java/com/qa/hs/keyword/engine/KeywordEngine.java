		...
		for (int i = 0; i < sheet.getLastRowNum(); i++) {
			try {
				...
				/*case "xpath3":
					...
					/*
					WebElement slider=driver.findElement(By.xpath(locatorValue));
				...
				/*case "xpath5":
					...
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Key Managerial Personnel')]")));
					element=driver.findElement(By.xpath(locatorValue));
				...
				case "xpath6":
					...
					element.click();
					wait = new WebDriverWait(driver,20);
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'GST Details')]")));
				...
				/*case "xpath7":
					...
					element.click();
					wait = new WebDriverWait(driver,20);
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Statutory Disclosures')]")));
					element=driver.findElement(By.xpath(locatorValue));
					element=driver.findElement(By.xpath(locatorValue));
					element=driver.findElement(By.xpath(locatorValue));
					element.click();
				...
				case "xpath8":
				    ...
				    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'New Transaction')]")));
					element=driver.findElement(By.xpath(locatorValue));
					element=driver.findElement(By.xpath(locatorValue));
					element=driver.findElement(By.xpath(locatorValue));
